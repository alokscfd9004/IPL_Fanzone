...
# ── IPL Historical Data ──
# Primary source: Kaggle dataset "slidescope/ipl-seasons-2008-to-2025-dataset",
# processed via `python manage.py process_ipl_data` into data/ipl_processed.json.
# The embedded dicts below are a fallback so the site works without the dataset.
...
IPL_SEASONS = {
    ...
    2026: {"champion": "Royal Challengers Bengaluru", "runner_up": "Gujarat Titans", "matches": 74, "sixes": None, "fours": None, "venues": 13},
}

# Verified IPL 2026 facts (sources: official IPL site, ESPNcricinfo — added manually
# until the Kaggle dataset releases its 2026 update)
SEASON_2026 = {
    "teams": 10,
    "half_centuries": None,
    "centuries": None,
    "orange_cap": {"player": "Vaibhav Sooryavanshi", "team": "Rajasthan Royals", "runs": 776},
    "purple_cap": {"player": "Kagiso Rabada", "team": "Gujarat Titans", "wickets": 29},
    "most_fours": {"player": "Sai Sudharsan", "team": "Gujarat Titans", "count": 75},
    "most_sixes": {"player": "Vaibhav Sooryavanshi", "team": "Rajasthan Royals", "count": 72},
    "points_table": [
        {"team": "Royal Challengers Bengaluru", "logo": "RCB", "pld": 14, "won": 9, "lost": 5, "nr": 0, "tie": 0, "pts": 18},
        {"team": "Gujarat Titans", "logo": "GT", "pld": 14, "won": 9, "lost": 5, "nr": 0, "tie": 0, "pts": 18},
        {"team": "Sunrisers Hyderabad", "logo": "SRH", "pld": 14, "won": 9, "lost": 5, "nr": 0, "tie": 0, "pts": 18},
        {"team": "Rajasthan Royals", "logo": "RR", "pld": 14, "won": 8, "lost": 6, "nr": 0, "tie": 0, "pts": 16},
        {"team": "Punjab Kings", "logo": "PBKS", "pld": 14, "won": 7, "lost": 6, "nr": 1, "tie": 0, "pts": 15},
        {"team": "Delhi Capitals", "logo": "DC", "pld": 14, "won": 7, "lost": 7, "nr": 0, "tie": 0, "pts": 14},
        {"team": "Kolkata Knight Riders", "logo": "KKR", "pld": 14, "won": 6, "lost": 7, "nr": 1, "tie": 0, "pts": 13},
        {"team": "Chennai Super Kings", "logo": "CSK", "pld": 14, "won": 6, "lost": 8, "nr": 0, "tie": 0, "pts": 12},
        {"team": "Mumbai Indians", "logo": "MI", "pld": 14, "won": 4, "lost": 10, "nr": 0, "tie": 0, "pts": 8},
        {"team": "Lucknow Super Giants", "logo": "LSG", "pld": 14, "won": 4, "lost": 10, "nr": 0, "tie": 0, "pts": 8},
    ],
    "final_note": "RCB defended their title — beat GT by 5 wickets at Ahmedabad (31 May). Virat Kohli 75* (42) was Player of the Match.",
}
...
# Upgrade embedded data with the real Kaggle dataset when it has been
# processed (python manage.py process_ipl_data). Real computed stats > guesses.
# Points tables: keep hand-verified embedded ones when present (dataset has
# minor league-match numbering quirks); datasets fill seasons that had none.
_curated_tables = {y: d["points_table"] for y, d in SEASON_DETAILS.items()
                   if d.get("points_table")}
_processed = load_processed(settings.BASE_DIR)
if _processed:
    _p_seasons, _p_details = _processed
    IPL_SEASONS.update(_p_seasons)
    SEASON_DETAILS.update(_p_details)
    for y, table in _curated_tables.items():
        SEASON_DETAILS[y]["points_table"] = table
    print(f"[HISTORY] Kaggle dataset loaded: {len(_p_seasons)} seasons of real data")
else:
    print("[HISTORY] data/ipl_processed.json not found — using embedded fallback data. "
          "Run: python manage.py process_ipl_data")
